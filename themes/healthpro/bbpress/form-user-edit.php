...
<form id="bbp-your-profile" method="post" enctype="multipart/form-data">
	...
	<fieldset class="bbp-form">
		...
		<div>
			...
			<span style="line-height: 28px">
				<strong><?php bbp_displayed_user_field( 'user_login', 'view' ); ?></strong>
			</span>
		</div>
	...
	<fieldset class="submit">
		...
		<div>
			...
			<button type="submit" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="button submit user-submit et_pb_button">
			<?php
			bbp_is_user_home_edit()
