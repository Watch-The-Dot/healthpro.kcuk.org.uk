...
<div style="display: none;" class="wpProQuiz_results">
	...
	<div class="ld-quiz-actions" style="margin: 10px 0px;">
		...
		<?php if ( ! $quiz->isBtnRestartQuizHidden() ) { ?>
			<input class="et_pb_button et_pb_bg_layout_light wpProQuiz_button_restartQuiz" type="button" name="restartQuiz"
		...
		if ( ! $quiz->isBtnViewQuestionHidden() ) {
			?>
			<input class="et_pb_button et_pb_bg_layout_light wpProQuiz_button_reShowQuestion" type="button" name="reShowQuestion"
					value="<?php // phpcs:ignore Squiz.PHP.EmbeddedPhp.ContentBeforeOpen,Squiz.PHP.EmbeddedPhp.ContentAfterOpen
						echo wp_kses_post(
							SFWD_LMS::get_template(
								'learndash_quiz_messages',
		...
		<?php if ( $quiz->isToplistActivated() && $quiz->getToplistDataShowIn() == WpProQuiz_Model_Quiz::QUIZ_TOPLIST_SHOW_IN_BUTTON ) { ?>
			<input class="et_pb_button et_pb_bg_layout_light" type="button" name="showToplist"
			value="<?php // phpcs:ignore Squiz.PHP.EmbeddedPhp.ContentBeforeOpen,Squiz.PHP.EmbeddedPhp.ContentAfterOpen
				echo wp_kses_post(
					SFWD_LMS::get_template(
						'learndash_quiz_messages',
